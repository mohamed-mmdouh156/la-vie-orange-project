      ...
      listener: (context,state){
        ...
        if(state is UserSignUpSuccessState){
          CashHelper.saveData(key: 'token',value: state.token).then((value) {
            customToast(title: 'Register Successfully', color: ColorManager.primary);
        ...
        if(state is UserSignUpErrorState){
          customToast(title: 'Register Failed, Check data and try again', color: ColorManager.red);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          state is UserSignInLoadingState? Padding(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text('or continue with',style: GoogleFonts.roboto(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 12,
                                  color: ColorManager.grey
                          ...
                          Row(
                            ...
                            children: [
                              const Image(
                                  image:AssetImage(AssetsManager.googleImage)
                              ),
                              SizedBox(width: 9.w,),
                              const Image(
                                  image:AssetImage(AssetsManager.facebookImage)
                              ),
                            ],
                          ),
                        ],
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            state is UserSignUpLoadingState? Padding(
                              padding: const EdgeInsets.all(17.0),
                              child: Center(
                                child: CircularProgressIndicator(
                                  color: ColorManager.primary,
                    ...
                    Align(
                      ...
                      child: Image(
                          height: 12.h,
                          width: 32.w,
                          image:const AssetImage(AssetsManager.loginImageBottom)
                      ),
                    ),
