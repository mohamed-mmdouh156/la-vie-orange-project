  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit,AppStates>(
      listener: (context,state){
        ...
        if(state is UpdateCurrentUserEmailSuccessState){
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: Text('Edit Email',style: GoogleFonts.roboto(
                                fontSize: 17.88.px,
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: Text('E-mail',style: GoogleFonts.roboto(
                                fontSize: 17.88.px,
                                fontWeight: FontWeight.w500,
                        ...
                        Container(
                          ...
                          child: DefaultFormField(
                              controller: cubit.currentEmailController,
                              validText: 'please enter your email'
                          ),
                        ),

                        state is UpdateCurrentUserEmailLoadingState?
                        Padding(
                        ...
                        Container(
                          ...
                          child: DefaultButton(
                              title: 'Update',
                              function: (){
                                cubit.updateCurrentUserEmail(
                                    cubit.currentEmailController.text,
                                );
                              }
                          ),
                        )
